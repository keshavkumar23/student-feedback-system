...
router.put('/faculty/:id/activate', adminControllers.activateFaculty);
router.put('/faculty/:id/deactivate', adminControllers.deactivateFaculty);
router.get('/faculty/score/:id', adminControllers.getFacultyScore);
